...
* Нужно сначала открыть Excel и потом кинуть в него файл, иначе он предлагает импорт с разбиением

### Колонки
#### Именование тест-кейса
Пример: login.reg.0001
* login — имя тестируемого модуля
* reg — имя подмодуля, в данном случае — регистрация
* 0001 — номер вариации тест-кейса
#### Тип тест-кейса
