...
3. Так же открывается и редактируется в Excel <sup>[3](https://github.com/Lagunov-PRO/TT_OK/blob/master/README.md#2)</sup>
...
## Примечания
###### 1
Файл [TestCases.csv](TestCases.csv), не отображается на гитхабе, т.к. Excel по-умолчанию разделяет ";", а гитхаб понимает только "," <sup>[2](https://github.com/Lagunov-PRO/TT_OK/blob/master/README.md#1)</sup>
###### 2 
Если добавить в начало файла sep=","
